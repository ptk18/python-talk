...
export default {
  ...
  setup() {
    ...
    const navItems = computed(() => [
      ...
      { id: 2, label: t.value.sidebar.history, iconSvg: historyIcon, path: '/conversation-manager' },
      { id: 3, label: t.value.sidebar.codeSpace, iconSvg: runIcon, path: '/workspace' },
      { id: 4, label: t.value.sidebar.turtle, iconSvg: turtleIcon, path: '/turtle-playground' },
      { id: 5, label: t.value.sidebar.settings, iconSvg: settingsIcon, path: '/settings' }
    ])
