...
from semantic_parsing.intent_parser import parse_intent
from semantic_parsing.parameter_extractor import extract_parameters
from method_matching.matcher import find_matching_methods, MatchResult
from method_matching.resolver import resolve_parameters, validate_parameters, generate_function_call
from extract_catalog_from_source_code.catalog import Catalog
from extract_catalog_from_source_code.ast_extractor import extract_from_file
...
def process_command(text: str, catalog: Catalog, class_name: str, verbose: bool = False, use_semantic: bool = True, hf_token: Optional[str] = None) -> Dict[str, Any]:
    trace = []
...
def process_complex_command(text: str, catalog: Catalog, class_name: str, verbose: bool = False, use_semantic: bool = True, hf_token: Optional[str] = None) -> Dict[str, Any]:
    """
    Process commands that may contain loops, conditionals, or conjunctions
    Returns structured result with generated code
    """
    from semantic_parsing.complex_sentence_parser import ComplexSentenceParser, print_command_tree
    from semantic_parsing.command_executor import CommandExecutor, ExecutionContext, format_executable_code
    ...
    if command_tree.type == 'action':
        return process_command(text, catalog, class_name, verbose, use_semantic, hf_token)

    def simple_processor(text: str, cat: Any, cls: str) -> Dict[str, Any]:
        return process_command(text, cat, cls, False, use_semantic, hf_token)
...
if __name__ == "__main__":
    ...
    # SOURCE_FILE = "./source_kbs/playlist.py"
    ...
    # TEST_CASES = ["add song Bohemian Rhapsody"]
