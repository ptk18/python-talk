...
import { messageAPI, conversationAPI, executeAPI, analyzeAPI, voiceAPI, fileAPI, paraphraseAPI, translateAPI } from "../services/api";
...
export default function Workspace() {
    ...
    useEffect(() => {
        ...
        console.log('═══════════════════════════════════════════');
        console.log('Current Language:', language === 'en' ? 'English' : 'Thai');
        console.log('STT Model:', language === 'en' ? 'Whisper (English)' : 'Whisper (Thai)');
        console.log('Translation Required:', language === 'th' ? 'Yes (Thai → English)' : 'No');
        console.log('═══════════════════════════════════════════');
    }, [language]);
    ...
    const handleSend = async (e: React.FormEvent) => {
        ...
        try {
            ...
            console.log('═════════════════════════════════════════════════════════════');
            console.log('Current Language:', language === 'en' ? 'English' : 'Thai');
            console.log('STT Model Used:', language === 'en' ? 'Whisper (English)' : 'Whisper (Thai)');
            ...
            try {
                ...
                recorder.onstop = async () => {
                    ...
                    try {
                        ...
                        console.log('Language:', language === 'en' ? 'English' : 'Thai');
                        console.log('STT Model:', language === 'en' ? 'Whisper (English)' : 'Whisper (Thai)');
                        ...
                        <div className="workspace__chat-input-container">
                            ...
                            <form className="workspace__input-form" onSubmit={handleSend}>
                                <input
                                    ...
                                    placeholder={isTranslating ? "Translating..." : "Type your message..."}
                                    value={message}
                                    onChange={(e) => setMessage(e.target.value)}
                                    disabled={isTranslating}
                                />
                                <button type="submit" className="workspace__send-btn" aria-label="Send message" disabled={isTranslating}>
                                    {isTranslating ? (
