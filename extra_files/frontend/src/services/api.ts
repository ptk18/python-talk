...
export const translateAPI = {
  /**
   * Translate text from Thai to English using Google Cloud Translation
   */
  translateToEnglish: async (text: string): Promise<TranslateResponse> => {
  ...
  /**
   * Translate text with custom source and target languages
   */
   ...
   */
  checkStatus: async (): Promise<{ available: boolean; message: string }> => {
